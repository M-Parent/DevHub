...
<Quiz
  id="terraform-modules-quiz"
  title="Terraform Modules Quiz"
  questions={[
    {
      ...
      correctAnswer: 1,
      explanation:
        "A module is a container for multiple resources that are used together, allowing for reusable infrastructure components.",
    },
    {
      ...
      correctAnswer: 3,
      explanation:
        "Modules can come from the Terraform Registry, local paths, Git repositories, S3 buckets, and other sources.",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "terraform init -upgrade downloads the latest versions of modules within version constraints.",
    },
  ]}
/>
