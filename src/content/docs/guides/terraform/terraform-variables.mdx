...
<Quiz
  id="terraform-variables-quiz"
  title="Terraform Variables Quiz"
  questions={[
    {
      ...
      correctAnswer: 1,
      explanation:
        "Variables without default values must be provided at runtime, either via prompt, -var flag, or .tfvars file.",
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        "Use var.variable_name to reference variables. Inside strings, use ${var.variable_name}.",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        ".tfvars files store variable values, keeping them separate from definitions in variables.tf.",
    },
  ]}
/>
