...
<Terminal
  commands={[
    {
      input: "terraform apply -var-file=dev.tfvars",
...
<FillBlank
  instruction="The name defined in the variable block"
  sentence="To reference a variable in Terraform, use: var.[BLANK:variable_name]"
/>
