...
<Quiz
  id="terraform-state-quiz"
  title="Terraform State Quiz"
  questions={[
    {
      ...
      correctAnswer: 1,
      explanation:
        "The state file maps your configuration to actual cloud resources and stores their current attributes.",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Without the state file, Terraform loses the connection between your config and existing resources.",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Workspaces let you maintain separate state files, useful for dev/staging/prod environments.",
    },
  ]}
/>
