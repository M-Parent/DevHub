...
(stdin)= d41d8cd98f00b204e9800998ecf8427e  ✓ Match!
```
...
<MatchPairs
  instruction="Match the openssl x509 flag with its output"
  pairs={[
    { left: "-subject", right: "Certificate subject DN" },
    { left: "-issuer", right: "CA that signed it" },
    { left: "-dates", right: "Validity period" },
    { left: "-fingerprint", right: "SHA hash of cert" },
  ]}
/>
...
<Terminal
  commands={[
    {
      input: "openssl x509 -in cert.pem -text -noout",
      output: "Certificate: Data: Version: 3 (0x2)",
    },
  ]}
/>
...
<FillBlank
  ...
  sentence="To verify a certificate against a CA: openssl [BLANK:verify] -CAfile ca.pem cert.pem"
/>
