...
<MatchPairs
  instruction="Match the CA file with its purpose"
  pairs={[
    { left: "cakey.pem", right: "CA private key" },
    { left: "cacert.pem", right: "CA certificate" },
    { left: "index.txt", right: "Certificate database" },
    { left: "serial", right: "Next serial number" },
  ]}
/>
...
<Terminal
  commands={[
    {
      input: "openssl genrsa -aes256 -out cakey.pem 4096",
...
<FillBlank
  ...
  sentence="To create a self-signed CA certificate valid for 10 years, use: openssl req -x509 -new -key cakey.pem -days [BLANK:3650] -out cacert.pem"
/>
