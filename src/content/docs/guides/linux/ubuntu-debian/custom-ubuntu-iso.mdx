---
title: "Automated Ubuntu Server ISO (≥20.04)"
...
<MatchPairs
  instruction="Match the autoinstall file with its purpose"
  pairs={[
    { left: "user-data", right: "Main autoinstall config" },
    { left: "meta-data", right: "Instance information" },
    { left: "grub.cfg", right: "Boot loader config" },
    { left: "md5sum.txt", right: "File integrity check" },
  ]}
/>
...
- ✅ Configures hostname, user, and network
- ✅ Enables SSH on first boot
- ✅ Installs essential packages
- ✅ Is ready for Ansible/Terraform automation
