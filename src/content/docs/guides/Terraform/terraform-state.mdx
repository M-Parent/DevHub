...
<Flashcard
  ...
  cards={[
    {
      front: "What is terraform.tfstate?",
      back: "A JSON file that maps your configuration to real-world resources and stores their current attributes.",
    },
    {
      front: "What's the difference between data and resource blocks?",
      back: "data blocks query existing resources, while resource blocks create new infrastructure.",
    },
    {
      front: "What are Terraform workspaces used for?",
      back: "Maintaining multiple state files for the same configuration (e.g., dev, staging, production environments).",
    },
    {
      front: "What happens if you lose your state file?",
      back: "Terraform loses the connection between your config and existing resources, making them unmanaged.",
    },
  ]}
/>

<MatchPairs
  instruction="Match the workspace command with its function"
  pairs={[
    { left: "terraform workspace list", right: "Show all workspaces" },
    { left: "terraform workspace new", right: "Create a workspace" },
    { left: "terraform workspace select", right: "Switch workspaces" },
    { left: "terraform workspace delete", right: "Remove a workspace" },
  ]}
/>
...
<FillBlank
  instruction="Command to create a new workspace"
  sentence="To create a new workspace named 'dev': terraform workspace [BLANK:new] dev"
/>
